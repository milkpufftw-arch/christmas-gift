  ...
  const WelcomeScreen = () => (
    <div className={`min-h-screen ${styles.bgGradient} flex flex-col items-center justify-center p-6 relative font-serif-tc`}>
      ...
      <div className="absolute top-6 right-6 flex gap-3 z-10">
        <button onClick={() => setScreen('history')} className={`p-2.5 bg-[#162032] text-[#94A3B8] rounded-full hover:text-white hover:bg-[#334155] transition-all border border-[#334155] flex items-center gap-2`} title="個人紀錄">
